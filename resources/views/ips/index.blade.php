            ...
            @foreach( $grouped as $group )
                <tr>
                    ...
                    <td>
                        ...
                        @if (Auth::check())
                            {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('ips.destroy', $group['id']), 'onsubmit' => 'return confirm(\'Are you sure to delete this hosts?\')')) !!}
                            {!! link_to_route('hosts.create', 'Host add', array('id' => $group['id']), array('class' => 'btn btn-info btn-xs')) !!}
                            {!! link_to_route('ips.edit', 'Edit', array($group['id']), array('class' => 'btn btn-info btn-xs')) !!}
